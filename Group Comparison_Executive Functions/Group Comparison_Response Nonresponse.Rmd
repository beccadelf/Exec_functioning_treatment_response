...
save_as_docx(
  ft,
  path = "Z:/Projekte_Meinke/Old_projects/Labrotation_Rebecca/Submission/Tables/Characteristics_Response_Nonresponse.docx", 
  pr_section = format_flextable_portrait)
save_as_docx(
  ft,
  path = "Z:/Projekte_Meinke/Old_projects/Labrotation_Rebecca/1_Group_comparison/R_vs_NR/Characteristics_Response_Nonresponse.docx", 
  pr_section = format_flextable_portrait)
ft
```
...
save_as_docx(
  ft_t_test,
  path = "Z:/Projekte_Meinke/Old_projects/Labrotation_Rebecca/1_Group_comparison/R_vs_NR/t-test_Responder_Nonresponder.docx", 
  pr_section = format_flextable_portrait)
```
...
ggsave("Z:/Projekte_Meinke/Old_projects/Labrotation_Rebecca/Submission/Figures/violin_plots_response_nonresponse.png", 
       plot = violin_plots_response_vs_nonresponse, width = 16, height = 9, dpi = 300)
ggsave("Z:/Projekte_Meinke/Old_projects/Labrotation_Rebecca/1_Group_comparison/R_vs_NR/violin_plots_response_nonresponse.png", 
       plot = violin_plots_response_vs_nonresponse, width = 16, height = 9, dpi = 300)
```
