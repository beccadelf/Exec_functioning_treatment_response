...
characteristics_tasks <- cbind(
  number_letter_df[, "**Characteristic**", drop = FALSE],  # Include "Characteristic" column only once
...
primary_headers <- c("Characteristic", "Number-Letter Task", "Number-Letter Task", 
