...
save_as_docx(
  ft,
  path = "Z:/Projekte_Meinke/Old_projects/Labrotation_Rebecca/Submission/Tables/Characteristics_Patients_HCs.docx", 
  pr_section = format_flextable_portrait)
save_as_docx(
  ft,
  path = "Z:/Projekte_Meinke/Old_projects/Labrotation_Rebecca/1_Group_comparison/HC_vs_Pat/Characteristics_Patients_HCs.docx", 
  pr_section = format_flextable_portrait)
ft
```
...
save_as_docx(
  ft_t_test,
  path = "Z:/Projekte_Meinke/Old_projects/Labrotation_Rebecca/1_Group_comparison/HC_vs_Pat/t-test_Patients_HCs.docx", 
  pr_section = format_flextable_portrait)
```
...
### 2. Test for task-specific differences in trait anxiety
```{r}
...
### 3. Plot trait anxiety difference
```{r, warning = FALSE}
...
ggsave("Z:/Projekte_Meinke/Old_projects/Labrotation_Rebecca/Submission/Figures/violin_plots_patients_hc.png", 
       plot = violin_plots_patients_hc, width = 16, height = 9, dpi = 300)
ggsave("Z:/Projekte_Meinke/Old_projects/Labrotation_Rebecca/1_Group_comparison/HC_vs_Pat/violin_plots_patients_hc.png", 
       plot = violin_plots_patients_hc, width = 16, height = 9, dpi = 300)
```
