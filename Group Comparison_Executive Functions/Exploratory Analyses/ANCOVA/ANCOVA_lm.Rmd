...
Regression of the dependent variable on the covariates is linear for each treatment condition. (The residuals plot has shown that this is valid in general, now we look at age extra)
...
table_summary$p_values_adjusted <- round(p.adjust(table_summary$p_value, method = "BH"),3)
...
colnames(table_summary) <- recode(colnames(table_summary),"Name" = "Performance Measure", 
                                  "error_reduction_due_to_predictor" = "Type III SS explained by Group",
                                  "F_value" = "F-Value",
                                  "p_value" = "p-Value",
...
save_as_docx(
  ft_t_test,
  path = "Z:/Projekte_Meinke/Old_projects/Labrotation_Rebecca/1_Group_comparison/ANCOVA/ANCOVA.docx", 
