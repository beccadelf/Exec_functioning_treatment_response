...
params:
  ...
  output_base_path: "Y:/PsyThera/Projekte_Meinke/Old_projects/Labrotation_Rebecca/1_Group_comparison"
...
results_path_HC_Pat <- create_results_path(inputdata_path = basic_path, 
                                           output_mainpath = file.path(params$output_base_path, "HC_vs_Pat"))
base_results_path_Response <- create_results_path(inputdata_path = basic_path, 
                                                  output_mainpath = file.path(params$output_base_path, "R_vs_NR"))
results_path_Response <- file.path(base_results_path_Response, params$response_criterion)
```
...
### 3.1. Non-Responder vs Responder
```{r}
