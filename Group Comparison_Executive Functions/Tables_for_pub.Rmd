...
```{r}
t_test_descr_pub <- prepare_ttest_table(ttest_table = t_test_descr_HC_Pat, var_type = "dimensional")
chi_sq_test_descr_pub <- prepare_ttest_table(ttest_table = chi_sq_test_descr_HC_Pat, var_type = "categorical")
...
```{r}
create_save_flextable(table_pub = descr_comps_pub, results_path = results_path_HC_Pat, file_name = "descr_tests_Patients_HCs.docx")
```
...
## 1. Healthy Controls and Patients
```{r}
# Select columns
