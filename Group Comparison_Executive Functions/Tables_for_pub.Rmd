...
for (i in seq_len(nrow(descr_comps_pub_HC_Pat))) {
  miss_hc <- descr_comps_pub_HC_Pat$Missings_HC[i]
...
descr_comps_pub_HC_Pat <- descr_comps_pub_HC_Pat[, !(names(descr_comps_pub_HC_Pat) %in% c("Missings_HC", "Missings_Patients"))]
