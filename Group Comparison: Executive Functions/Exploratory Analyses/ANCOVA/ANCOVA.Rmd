...
data_Pat_pre <- read.csv("Z:/PsyThera/Projekte_Meinke/Old_projects/Labrotation_Rebecca/Daten_Gruppenvergleich/With_wrong_responses/Data_Patients_Pre.csv")
data_Pat_post <- read.csv("Z:/PsyThera/Projekte_Meinke/Old_projects/Labrotation_Rebecca/Daten_Gruppenvergleich/With_wrong_responses/Data_Patients_Post.csv")
```

## Subject Data
```{r}
data_all <- haven::read_dta('Y:/PsyThera/Projekte_Meinke/Old_projects/Labrotation_Rebecca/CognitiveControl_Treatment/Data_Kevin_28.07.23.dta')
...
# TODO: imp_columns ist das gleiche wie performance_tasks -> Bitte reduzieren
...
## Linearity between age and performance, corrected for group, education, and sex</u>
```{r}
# TODO: Statt <u> #### verwenden
...
## Linearity of direct relationship between a covariate and the outcome within the groups
```{r}
...
## Non-interaction between covariates and predictor (categorical) and Homogeneity of slopes within regression (continuous) ###
```{r}
