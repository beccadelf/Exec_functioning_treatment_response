...
# 4. Calculate BIS (and Difference Score) for each condition and subject separately
BIS = Z(PC) - Z(RT)
...
# 5. Create separate dataframes for each group (HC, patient_pre, patient_post)
...
# 6. Save dataframes for analyses
```{r Save dataframes}
file_path <- "Z:/Projekte_Meinke/Old_projects/Labrotation_Rebecca/Daten_Gruppenvergleich/With_wrong_responses/Performance_Scores/"
...
# 7. Add sociodemographic and clinical data