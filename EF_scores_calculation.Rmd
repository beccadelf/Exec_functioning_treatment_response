...
IDs of task-data with no group identity (93 in total):
...
--> all other 85 IDs were generated at MZP2
...
write_data_to_csv <- function(data, filename) {
  base_path <- "Z:/PsyThera/Projekte_Meinke/Labrotation_Rebecca/Daten_Gruppenvergleich/"
