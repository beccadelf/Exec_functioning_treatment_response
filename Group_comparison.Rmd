...
```{r}
NumberLetter_HC <- read.csv("Y:/Projekte_Meinke/Labrotation_Rebecca/Daten_Gruppenvergleich/NumberLetter_HC.csv")
NumberLetter_Patients_Post <- read.csv("Y:/Projekte_Meinke/Labrotation_Rebecca/Daten_Gruppenvergleich/NumberLetter_Patients_Post.csv")
NumberLetter_Patients_Pre <-  read.csv("Y:/Projekte_Meinke/Labrotation_Rebecca/Daten_Gruppenvergleich/NumberLetter_Patients_Pre.csv")

Stroop_HC <- read.csv("Y:/Projekte_Meinke/Labrotation_Rebecca/Daten_Gruppenvergleich/Stroop_HC.csv")
Stroop_Patients_Post <-  read.csv("Y:/Projekte_Meinke/Labrotation_Rebecca/Daten_Gruppenvergleich/Stroop_Patients_Post.csv")
Stroop_Patients_Pre <-  read.csv("Y:/Projekte_Meinke/Labrotation_Rebecca/Daten_Gruppenvergleich/Stroop_Patients_Pre.csv")

TwoBack_HC <- read.csv("Y:/Projekte_Meinke/Labrotation_Rebecca/Daten_Gruppenvergleich/TwoBack_HC.csv")
TwoBack_Patients_Post <-  read.csv("Y:/Projekte_Meinke/Labrotation_Rebecca/Daten_Gruppenvergleich/TwoBack_Patients_Post.csv")
TwoBack_Patients_Pre <-  read.csv("Y:/Projekte_Meinke/Labrotation_Rebecca/Daten_Gruppenvergleich/TwoBack_Patients_Pre.csv")
```

## Import 
```{r}
data_all <- haven::read_dta('Y:/Projekte_Meinke/Labrotation_Rebecca/CRC_C5_Hilbert/CRC_C5_Hilbert/Data_Kevin_28.07.23.dta')
...
```
Data for `r nrow(Patients_vs_HC_imp[Patients_vs_HC_imp$Gruppe == 0,])` patients and `r nrow(Patients_vs_HC_imp[Patients_vs_HC_imp$Gruppe == 0,])` healthy controls were available.
