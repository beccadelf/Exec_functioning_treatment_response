...
#I needed to implement this ebcause the "formula method" using ~ didn't work for me, for some reason. I looked for a solution quite a while, but didn't find anything :/ 
#That's why I used this helper function to avoid redundancy and get pre and post data in one place for the Welch test, too.
# - Till
