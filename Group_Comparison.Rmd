...
data_Pat_pre$Subject <- data_Pat_pre$Subject + 600
common_subjects <- intersect(data_Pat_pre$Subject, data_Pat_post$Subject) #Using intersect function to exclude only pre/post cases

# 2. Filter the datasets to only include common subjects
data_Pat_pre_filtered <- data_Pat_pre[data_Pat_pre$Subject %in% common_subjects, ]
data_Pat_post_filtered <- data_Pat_post[data_Pat_post$Subject %in% common_subjects, ]
