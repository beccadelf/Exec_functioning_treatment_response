...
path_results_folder = file.path(basic_path, "Results\\RT_trimmed_RT_wrong_removed_outliers-removed\\Response_BAT\\Results")
plots_path = file.path(dirname(path_results_folder), "Plots/")
...
```{r}
# Get all folders in the results folder (each containing the results of another model)
combined_results <- load_and_combine_results(path_results_folder, file_name = "performance_across_iters")
