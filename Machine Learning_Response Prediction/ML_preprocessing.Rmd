...
write.csv(all_features_final, paste0(file_path, "all_features.csv"), row.names = FALSE)
write.csv(features_df_enc, paste0(file_path, "all_features_accuracy.csv"), row.names = FALSE)
