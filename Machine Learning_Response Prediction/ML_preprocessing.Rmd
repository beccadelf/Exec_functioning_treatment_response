...
all_features_reduced <- all_features_final[, !names(all_features_final) %in% discarded_features]
```
...
write.csv(all_features_reduced, file.path(output_path_share, "all_features.csv"), row.names = FALSE)
