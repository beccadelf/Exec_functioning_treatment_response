...
#%% Classes used for scaling

# These two classes fulfill two basic functions: 
    # 1. Apply scaling to only dimensional features (more than 2 unique values)
    # 2. Reorder the columns back to their original order after the transformation
...
#%% Class to exclude features with no variance and/or high inter-correlation
