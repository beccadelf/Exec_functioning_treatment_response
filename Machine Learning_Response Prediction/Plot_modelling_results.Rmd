...
results_folders <- results_folders[grepl("new4", results_folders)]
...
create_classification_plot <- function(results_df){
  ...
  results_df$Model <- ifelse(grepl("random_forest_classifier_yes_simple", results_df$FolderName),
                             "Random Forest\n(Oversampled)",
                      ...
                      ifelse(grepl("random_forest_classifier_no_oversampling", results_df$FolderName),
                             "Random Forest",
                      ifelse(grepl("svm_classifier_C1_yes_smote", results_df$FolderName),
                             "SVM\n(Smote Oversampled)",
                      ifelse(grepl("svm_classifier_C1_yes_simple", results_df$FolderName), 
                             "SVM\n(Oversampled)",
                      ifelse(grepl("svm_classifier_C1_no_oversampling", results_df$FolderName), 
                             "SVM", NA))))))
